⏩ Email : admin@gmail.com ⏩  password : admin ⏩ Study Groups app using Django in which users can signup, login, logout, edit profile, change password, create groups, message in any group, etc.
